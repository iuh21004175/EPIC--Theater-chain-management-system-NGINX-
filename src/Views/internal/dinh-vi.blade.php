...
@section('title', 'Quản lý thông tin định vị')

@section('head')
    <script type="module" src="{{$_ENV['URL_INTERNAL_BASE']}}/js/dinh-vi.js"></script>
@endsection
...
<li>
    <div class="flex items-center">
        ...
        <span class="ml-4 text-gray-500 font-medium">Thông tin định vị</span>
    </div>
</li>
@endsection
...
@section('content')
    ...
    <div class="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
        <div>
            <h3 class="text-lg leading-6 font-medium text-gray-900">Quản lý thông tin định vị</h3>
            <p class="mt-1 text-sm text-gray-500">Cấu hình thông tin WiFi để xác định vị trí chấm công cho nhân viên</p>
        </div>
    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                <strong>Lưu ý:</strong> Thông tin định vị này sẽ được sử dụng để xác minh vị trí khi nhân viên chấm công. 
                                Đảm bảo địa chỉ IP và tên WiFi chính xác để hệ thống có thể nhận diện đúng vị trí.
                            </p>
                        </div>
                    </div>
                </div>
