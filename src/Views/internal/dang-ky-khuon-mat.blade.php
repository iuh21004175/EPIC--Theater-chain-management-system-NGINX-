...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen" data-url="{{ $_ENV['URL_WEB_BASE'] }}">
    <main class="max-w-6xl mx-auto py-6 sm:py-10 px-4 sm:px-6 lg:px-8">
        <!-- Header Card -->
        <div class="mb-6 bg-white rounded-2xl shadow-lg p-6 sm:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Đăng ký khuôn mặt</h1>
                    <p class="mt-2 text-sm text-gray-600">Thiết lập nhận diện khuôn mặt để chấm công nhanh chóng</p>
                </div>
                <button id="openGuideBtn" aria-label="Xem hướng dẫn" title="Xem hướng dẫn" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-green-600 to-green-700 text-white hover:from-green-700 hover:to-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 transition-all duration-200 shadow-lg hover:shadow-xl font-medium">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100">
                        <div class="flex flex-col sm:flex-row sm:items-end gap-3">
                            <div class="flex-1">
                                ...
                                <select id="cameraSelect" class="w-full border-2 border-blue-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">
                                    <option value="">Tự động</option>
                                </select>
                            </div>
                            <button id="btnSelectCamera" class="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium transition-all duration-200 shadow-md">
                                Sử dụng
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-gray-900" style="width:100%; aspect-ratio:16/9;">
                        ...
                        <div class="absolute inset-0 pointer-events-none">
                            <div class="absolute inset-8 sm:inset-12 border-2 border-white/40 rounded-2xl"></div>
                            <div class="absolute top-8 sm:top-12 left-8 sm:left-12 w-6 h-6 border-t-4 border-l-4 border-green-500 rounded-tl-lg"></div>
                            <div class="absolute top-8 sm:top-12 right-8 sm:right-12 w-6 h-6 border-t-4 border-r-4 border-green-500 rounded-tr-lg"></div>
                            <div class="absolute bottom-8 sm:bottom-12 left-8 sm:left-12 w-6 h-6 border-b-4 border-l-4 border-green-500 rounded-bl-lg"></div>
                            <div class="absolute bottom-8 sm:bottom-12 right-8 sm:right-12 w-6 h-6 border-b-4 border-r-4 border-green-500 rounded-br-lg"></div>
                        </div>
                    </div>

                    <!-- Face Notification -->
                    <div id="faceNotify" class="p-4 sm:p-6 bg-gray-50 text-center">
                        <p class="text-base sm:text-lg font-semibold text-gray-700"></p>
                    </div>

                    <!-- Action Buttons -->
                    <div class="p-4 sm:p-6 space-y-3 bg-gray-50 border-t border-gray-200">
                        ...
                        <a href="{{ $_ENV['URL_INTERNAL_BASE'] }}/cham-cong" class="block w-full text-center bg-gray-200 text-gray-700 py-4 rounded-xl hover:bg-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold transition-all duration-200">
                            <span class="flex items-center justify-center gap-2">
            ...
            <div class="lg:col-span-1">
                <div id="progressContainer" class="bg-white rounded-2xl shadow-lg p-6 space-y-6 hidden sticky top-6">
                    <div class="flex items-center gap-3 pb-4 border-b border-gray-200">
                        ...
                        <h3 class="text-lg font-bold text-gray-900">Tiến trình đăng ký</h3>
                    </div>

                    <!-- Quality Progress -->
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-semibold text-gray-700">Chất lượng mẫu</span>
                            <span id="qualityRatio" class="text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">0/100</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                            <div id="qualityProgress" class="bg-gradient-to-r from-blue-500 to-blue-600 h-3 rounded-full transition-all duration-300 shadow-sm" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-semibold text-gray-700">Phát hiện khuôn mặt</span>
                            <span id="faceRatio" class="text-sm font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full">0/100</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                            <div id="faceProgress" class="bg-gradient-to-r from-green-500 to-green-600 h-3 rounded-full transition-all duration-300 shadow-sm" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-semibold text-gray-700">Phát hiện giả mạo</span>
                            <span id="faceDetected" class="text-sm font-bold text-purple-600 bg-purple-50 px-3 py-1 rounded-full">0/1</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                            <div id="spoofProgress" class="bg-gradient-to-r from-purple-500 to-purple-600 h-3 rounded-full transition-all duration-300 shadow-sm" style="width: 0%"></div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-semibold text-gray-700">Chuyển đổi dữ liệu</span>
                            <span id="dataTransferred" class="text-sm font-bold text-orange-600 bg-orange-50 px-3 py-1 rounded-full">0/1</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                            <div id="dataProgress" class="bg-gradient-to-r from-orange-500 to-orange-600 h-3 rounded-full transition-all duration-300 shadow-sm" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
            </div>
